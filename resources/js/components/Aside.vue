    ...
    <div class="sidenav-header">
      ...
      <Link class="navbar-brand m-0" href="/">
        <img
          ...
          alt="main_logo"
        />
        <span class="ms-1 font-weight-bold">Wovie</span>
      </Link>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <Link
            ...
            :class="
              route().current('anime') ||
              route().current('anime.create') ||
              route().current('anime.edit') ||
              route().current('episodes') ||
              route().current('episode.edit')
                ? 'active'
                : ''
            "
            :href="route('anime')"
        ...
        <li class="nav-item">
          <Link
            class="nav-link"
            :class="route().current('genres') ? 'active' : ''"
            :href="route('genres')"
          >
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
          ...
          >
            <ul class="nav ms-4 ps-3">
              <li class="nav-item">
                <Link
                  class="nav-link"
                  :class="route().current('country') ? 'active' : ''"
                  :href="route('country')"
                >
              ...
              <li class="nav-item">
                <Link
                  class="nav-link"
                  :class="route().current('producer') ? 'active' : ''"
                  :href="route('producer')"
                >
                  <span class="sidenav-normal"> Producers </span>
                </Link>
              </li>
              <li class="nav-item">
                <Link
                  class="nav-link"
                  :class="route().current('services') ? 'active' : ''"
                  :href="route('services')"
                >
